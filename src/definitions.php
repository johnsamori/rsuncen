...
return [
    ...
    "cors.middleware.options" => Config("CORS") + ["logger" => \DI\get("app.logger")],
    ...
    "appointments" => \DI\autowire(Appointments::class),
    "doctors" => \DI\autowire(Doctors::class),
    "hospitalization" => \DI\autowire(Hospitalization::class),
    "medical_records" => \DI\autowire(MedicalRecords::class),
    "patients" => \DI\autowire(Patients::class),
    "pharmacy" => \DI\autowire(Pharmacy::class),
    "rooms" => \DI\autowire(Rooms::class),
    "transactions" => \DI\autowire(Transactions::class),
