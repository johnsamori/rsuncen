...
<form name="fdoctorsview" id="fdoctorsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script<?= Nonce() ?>>
...
<?php if ($Page->user_id->Visible) { // user_id ?>
    <tr id="r_user_id"<?= $Page->user_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doctors_user_id"><?= $Page->user_id->caption() ?></span></td>
...
<?php if ($Page->full_name->Visible) { // full_name ?>
    <tr id="r_full_name"<?= $Page->full_name->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doctors_full_name"><?= $Page->full_name->caption() ?></span></td>
...
<?php if ($Page->specialization->Visible) { // specialization ?>
    <tr id="r_specialization"<?= $Page->specialization->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doctors_specialization"><?= $Page->specialization->caption() ?></span></td>
...
<?php if ($Page->phone_number->Visible) { // phone_number ?>
    <tr id="r_phone_number"<?= $Page->phone_number->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_doctors_phone_number"><?= $Page->phone_number->caption() ?></span></td>
