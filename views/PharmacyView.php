...
<form name="fpharmacyview" id="fpharmacyview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script<?= Nonce() ?>>
...
<?php if ($Page->name->Visible) { // name ?>
    <tr id="r_name"<?= $Page->name->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_name"><?= $Page->name->caption() ?></span></td>
...
<?php if ($Page->description->Visible) { // description ?>
    <tr id="r_description"<?= $Page->description->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_description"><?= $Page->description->caption() ?></span></td>
...
<?php if ($Page->stock->Visible) { // stock ?>
    <tr id="r_stock"<?= $Page->stock->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_stock"><?= $Page->stock->caption() ?></span></td>
...
<?php if ($Page->price->Visible) { // price ?>
    <tr id="r_price"<?= $Page->price->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_price"><?= $Page->price->caption() ?></span></td>
