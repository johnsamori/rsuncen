...
<form name="ftransactionsedit" id="ftransactionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script<?= Nonce() ?>>
var currentTable = <?= json_encode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { transactions: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var ftransactionsedit;
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_transactions_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_transactions_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="transactions" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script<?= Nonce() ?>>
loadjs.ready(['ftransactionsedit', 'jqueryinputmask'], function() {
	options = {
		'alias': 'numeric',
		'autoUnmask': true,
		'jitMasking': false,
	...
	ew.createjQueryInputMask("ftransactionsedit", "x_patient_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['ftransactionsedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftransactionsedit", "x_pharmacy_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['ftransactionsedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftransactionsedit", "x_quantity", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['ftransactionsedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftransactionsedit", "x_total_price", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<script<?= Nonce() ?>>
loadjs.ready(["ftransactionsedit", "datetimepicker"], function () {
...
loadjs.ready(['ftransactionsedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftransactionsedit", "x_transaction_date", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="ftransactionsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftransactionsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
