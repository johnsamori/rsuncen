...
<link rel="stylesheet" href="<?= $basePath ?>css/select2.min.css?v=25.2.6">
<link rel="stylesheet" href="<?= $basePath ?>css/select2-bootstrap5.min.css?v=25.2.6">
<link rel="stylesheet" href="<?= $basePath ?><?= Config("FONT_AWESOME_STYLESHEET") ?>?v=25.2.6">
<link rel="stylesheet" href="<?= $basePath ?>css/jquery.overlayScrollbars.css?v=25.2.6">
...
<link rel="stylesheet" href="<?= $basePath ?><?= CssFile(Config("PROJECT_STYLESHEET_FILENAME")) ?>?v=25.2.6">
...
<script<?= Nonce() ?> data-pace-options='<?= json_encode(Config("PACE_OPTIONS")) ?>' src="<?= $basePath ?>js/pace.js?v=25.2.6"></script><!-- Single quotes for data-pace-options -->
<?php // === Begin modification by Masino Sinaga, September 9, 2023 ==- \\ ?>
...
loadjs(ew.PATH_BASE + "jquery/jquery.min.js?v=25.2.6", "jquery");
loadjs(ew.PATH_BASE + "js/popper.min.js?v=25.2.6", "popper");
loadjs(ew.PATH_BASE + "js/luxon.min.js?v=25.2.6", "luxon");
loadjs([
    ew.PATH_BASE + "js/ua-parser.min.js?v=25.2.6",
    ew.PATH_BASE + "js/purify.min.js?v=25.2.6",
    ew.PATH_BASE + "js/cropper.min.js?v=25.2.6",
    ew.PATH_BASE + "jquery/load-image.all.min.js?v=25.2.6"
], "others");
loadjs([ew.PATH_BASE + "js/sweetalert2.min.js?v=25.2.6", ew.PATH_BASE + "css/sweetalert2.min.css?v=25.2.6"], "swal");
<?= $Language->toJson() ?>
ew.vars = <?= json_encode(GetClientVar()) ?>;
ew.ready(["wrapper", "jquery"], ew.PATH_BASE + "jquery/jsrender.min.js?v=25.2.6", "jsrender", ew.renderJsTemplates);
ew.ready("jsrender", ew.PATH_BASE + "jquery/jquery.overlayScrollbars.min.js?v=25.2.6", "scrollbars"); // Init sidebar scrollbars after rendering menu
ew.ready("jquery", ew.PATH_BASE + "jquery/jquery-ui.min.js?v=25.2.6", "widget");
...
<script<?= Nonce() ?>>
var cssfiles = [
    ew.PATH_BASE + "css/jquery.fileupload.css?v=25.2.6",
    ew.PATH_BASE + "css/jquery.fileupload-ui.css?v=25.2.6",
    ew.PATH_BASE + "css/cropper.min.css?v=25.2.6"
];
cssfiles.push(ew.PATH_BASE + "colorbox/colorbox.css?v=25.2.6");
loadjs(cssfiles, "css");
var cssjs = [];
<?php foreach (array_merge(Config("STYLESHEET_FILES"), Config("JAVASCRIPT_FILES")) as $file) { // External Stylesheets and JavaScripts ?>
cssjs.push("<?= (IsRemote($file) ? "" : BasePath(true)) . $file ?>?v=25.2.6");
<?php } ?>
var jqueryjs = [
    ew.PATH_BASE + "jquery/select2.full.min.js?v=25.2.6",
    ew.PATH_BASE + "jquery/jqueryfileupload.min.js?v=25.2.6",
    ew.PATH_BASE + "jquery/typeahead.jquery.min.js?v=25.2.6"
];
jqueryjs.push(ew.PATH_BASE + "jquery/pStrength.jquery.min.js?v=25.2.6");
jqueryjs.push(ew.PATH_BASE + "jquery/pGenerator.jquery.min.js?v=25.2.6");
jqueryjs.push(ew.PATH_BASE + "colorbox/jquery.colorbox.min.js?v=25.2.6");
jqueryjs.push(ew.PATH_BASE + "js/pdfobject.min.js?v=25.2.6");
ew.ready(["jquery", "dom", "popper"], ew.PATH_BASE + "bootstrap5/js/bootstrap.min.js?v=25.2.6", "bootstrap"); // Bootstrap
ew.ready("popper", [ew.PATH_BASE + "js/tippy.umd.min.js?v=25.2.6", ew.PATH_BASE + "css/tippy.css?v=25.2.6",], "tippy"); // Tippy
...
<script<?= Nonce() ?>>
loadjs(ew.PATH_BASE + "css/<?= CssFile("tempus-dominus.css") ?>?v=25.2.0");
ew.ready("head", [
    ew.PATH_BASE + "js/tempus-dominus.min.js?v=25.2.0",
    ew.PATH_BASE + "js/ewdatetimepicker.min.js?v=25.2.0"
], "datetimepicker");
</script>
<script>
ew.ready("head", [
...
<script<?= Nonce() ?>>
ew.ready("head", [ew.PATH_BASE + "tinymce/tinymce.min.js?v=25.2.0", ew.PATH_BASE + "js/eweditor.js?v=25.2.0"], "editor");
</script>
<style<?= Nonce() ?>>
...
ew.ready(["jquery", "bootstrap"], [[
    ew.PATH_BASE + "plugins/colorpicker/css/bootstrap-colorpicker.min.css?v=25.2.0",
    ew.PATH_BASE + "plugins/colorpicker/js/bootstrap-colorpicker.min.js?v=25.2.0"
]], "colorpicker");
...
<meta name="generator" content="PHPMaker 2025.2.0">
</head>
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="#" data-ew-action="none">
                    <span class="brand-text">SIM RS UNCEN</span>
                </a>
            </ul>
            <!-- Right navbar links -->
