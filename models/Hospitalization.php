...
/**
 * Table class for hospitalization
 */
class Hospitalization extends DbTable
{
    ...
    public DbField $room_id;
    public DbField $admission_date;
    public DbField $discharge_date;
    public DbField $total_cost;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "hospitalization"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->patient_id->PleaseSelectText = $this->language->phrase("PleaseSelect"); // "PleaseSelect" text
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->patient_id->Lookup = new Lookup($this->patient_id, 'patients', false, 'id', ["full_name","","",""], '', "", [], [], [], [], [], [], false, '', '', "`full_name`");
                break;
            default:
                $this->patient_id->Lookup = new Lookup($this->patient_id, 'patients', false, 'id', ["full_name","","",""], '', "", [], [], [], [], [], [], false, '', '', "`full_name`");
                break;
        ...
        $this->room_id->setSelectMultiple(false); // Select one
        $this->room_id->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->room_id->PleaseSelectText = $this->language->phrase("PleaseSelect"); // "PleaseSelect" text
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->room_id->Lookup = new Lookup($this->room_id, 'rooms', false, 'room_number', ["room_number","","",""], '', "", [], [], [], [], [], [], false, '', '', "`room_number`");
                break;
            default:
                $this->room_id->Lookup = new Lookup($this->room_id, 'rooms', false, 'room_number', ["room_number","","",""], '', "", [], [], [], [], [], [], false, '', '', "`room_number`");
                break;
        }
        $this->room_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        ...
        $this->admission_date = new DbField(
            ...
            CastDateFieldForLike("`admission_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->admission_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        ...
        $this->discharge_date = new DbField(
            ...
            CastDateFieldForLike("`discharge_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->discharge_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->discharge_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->total_cost = new DbField(
            ...
            '`total_cost`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
        ...
        $this->total_cost->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "hospitalization";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("hospitalizationlist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "hospitalizationview" => $this->language->phrase("View"),
            "hospitalizationedit" => $this->language->phrase("Edit"),
            "hospitalizationadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "HospitalizationView",
            Config("API_ADD_ACTION") => "HospitalizationAdd",
            Config("API_EDIT_ACTION") => "HospitalizationEdit",
            Config("API_DELETE_ACTION") => "HospitalizationDelete",
            Config("API_LIST_ACTION") => "HospitalizationList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("hospitalizationview", $parm);
        } else {
            $url = $this->keyUrl("hospitalizationview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "hospitalizationadd?" . $parm;
        } else {
            $url = "hospitalizationadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("hospitalizationedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("hospitalizationlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("hospitalizationadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("hospitalizationlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("hospitalizationdelete", $parm);
        }
    }
