 ...
 * Page class
 */
class DoctorsView extends Doctors
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DoctorsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "doctorsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "doctorslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "doctorslist"; // No matching record, return to list
                    } else {
