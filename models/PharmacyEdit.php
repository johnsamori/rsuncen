...
class PharmacyEdit extends Pharmacy
{
    ...
    // Page object name
    public string $PageObjName = "PharmacyEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "pharmacyedit";
...
// Get upload files
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // stock
        $this->stock->setDbValueDef($newRow, $this->stock->CurrentValue, $this->stock->ReadOnly);
