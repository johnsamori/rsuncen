...
class DoctorsAdd extends Doctors
{
    ...
    // Page object name
    public string $PageObjName = "DoctorsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "doctorsadd";
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // specialization
        $this->specialization->setDbValueDef($newRow, $this->specialization->CurrentValue, false);
