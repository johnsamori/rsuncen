 ...
 * Page class
 */
class HospitalizationView extends Hospitalization
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "HospitalizationView";
    ...
    // CSS class/style
    public string $CurrentPageName = "hospitalizationview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "hospitalizationlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "hospitalizationlist"; // No matching record, return to list
                    } else {
