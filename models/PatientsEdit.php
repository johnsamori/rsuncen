...
class PatientsEdit extends Patients
{
    ...
    // Page object name
    public string $PageObjName = "PatientsEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "patientsedit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("patientslist"); // Return to list page
                        return;
...
// Get upload files
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // dob
        $this->dob->setDbValueDef($newRow, UnFormatDateTime($this->dob->CurrentValue, $this->dob->formatPattern()), $this->dob->ReadOnly);
        ...
        // address
        $this->address->setDbValueDef($newRow, $this->address->CurrentValue, $this->address->ReadOnly);
        return $newRow;
    }
