...
class Users extends DbTable
{
    ...
    {
        // Add User ID filter
        if ($this->security->currentUserID() != "" && !$this->security->isAdmin()) { // Non system admin
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->security->isAdmin() && $this->security->isLoggedIn()) { // Non system admin
    ...
    public function addUserIDFilter(string $filter = "", string $id = ""): string
    {
        ...
        if (!$this->userIDAllow($id) && !$this->security->isAdmin()) {
    ...
    public function addParentUserIDFilter(mixed $userId): string
    {
