...
/**
 * Table class for medical_records
 */
class MedicalRecords extends DbTable
{
    ...
    public DbField $visit_date;
    public DbField $diagnosis;
    public DbField $treatment;
    public DbField $prescription;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "medical_records"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->visit_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->visit_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['visit_date'] = &$this->visit_date;

        // diagnosis
        $this->diagnosis = new DbField(
            $this, // Table
            'x_diagnosis', // Variable name
            'diagnosis', // Name
            '`diagnosis`', // Expression
            '`diagnosis`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`diagnosis`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->diagnosis->InputTextType = "text";
        $this->diagnosis->Nullable = false; // NOT NULL field
        $this->diagnosis->Required = true; // Required field
        $this->diagnosis->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['diagnosis'] = &$this->diagnosis;

        // treatment
        $this->treatment = new DbField(
            $this, // Table
            'x_treatment', // Variable name
            'treatment', // Name
            '`treatment`', // Expression
            '`treatment`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`treatment`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->treatment->InputTextType = "text";
        $this->treatment->Nullable = false; // NOT NULL field
        $this->treatment->Required = true; // Required field
        $this->treatment->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['treatment'] = &$this->treatment;

        // prescription
        $this->prescription = new DbField(
            $this, // Table
            'x_prescription', // Variable name
            'prescription', // Name
            '`prescription`', // Expression
            '`prescription`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`prescription`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->prescription->InputTextType = "text";
        $this->prescription->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['prescription'] = &$this->prescription;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "medical_records";
    }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->prescription->DbValue = $row['prescription'];
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("medicalrecordslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "medicalrecordsview" => $this->language->phrase("View"),
            "medicalrecordsedit" => $this->language->phrase("Edit"),
            "medicalrecordsadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MedicalRecordsView",
            Config("API_ADD_ACTION") => "MedicalRecordsAdd",
            Config("API_EDIT_ACTION") => "MedicalRecordsEdit",
            Config("API_DELETE_ACTION") => "MedicalRecordsDelete",
            Config("API_LIST_ACTION") => "MedicalRecordsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicalrecordsview", $parm);
        } else {
            $url = $this->keyUrl("medicalrecordsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "medicalrecordsadd?" . $parm;
        } else {
            $url = "medicalrecordsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicalrecordsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicalrecordslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicalrecordsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicalrecordslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("medicalrecordsdelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->prescription->EditValue = $this->prescription->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->prescription);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->patient_id);
                    $doc->exportCaption($this->doctor_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->prescription);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->patient_id);
                        $doc->exportField($this->doctor_id);
