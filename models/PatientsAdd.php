...
class PatientsAdd extends Patients
{
    ...
    // Page object name
    public string $PageObjName = "PatientsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "patientsadd";
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'dob' before field var 'x_dob'
        $val = $this->hasFormValue("dob") ? $this->getFormValue("dob") : $this->getFormValue("x_dob");
        ...
        $val = $this->hasFormValue("address") ? $this->getFormValue("address") : $this->getFormValue("x_address");
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->dob->Visible && $this->dob->Required) {
                if (!$this->dob->IsDetailKey && IsEmpty($this->dob->FormValue)) {
            ...
            if ($this->address->Visible && $this->address->Required) {
                if (!$this->address->IsDetailKey && IsEmpty($this->address->FormValue)) {
    ...
    protected function getAddRow(): array
    {
        ...
        // full_name
        $this->full_name->setDbValueDef($newRow, $this->full_name->CurrentValue, false);

        // dob
        $this->dob->setDbValueDef($newRow, UnFormatDateTime($this->dob->CurrentValue, $this->dob->formatPattern()), false);

        // gender
        $this->gender->setDbValueDef($newRow, $this->gender->CurrentValue, false);

        // phone_number
        $this->phone_number->setDbValueDef($newRow, $this->phone_number->CurrentValue, false);

        // address
        $this->address->setDbValueDef($newRow, $this->address->CurrentValue, false);
        return $newRow;
    }
