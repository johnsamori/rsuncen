 ...
 * Page class
 */
class DoctorsDelete extends Doctors
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DoctorsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "doctorsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("doctorslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("doctorslist"); // Return to list
                return;
            }
        }
