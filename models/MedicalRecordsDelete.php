 ...
 * Page class
 */
class MedicalRecordsDelete extends MedicalRecords
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MedicalRecordsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "medicalrecordsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("medicalrecordslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("medicalrecordslist"); // Return to list
                return;
            }
        }
