...
class AppointmentsAdd extends Appointments
{
    ...
    // CSS class/style
    public string $CurrentPageName = "appointmentsadd";
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // appointment_date
        $this->appointment_date->setDbValueDef($newRow, UnFormatDateTime($this->appointment_date->CurrentValue, $this->appointment_date->formatPattern()), false);
