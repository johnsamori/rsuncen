 ...
 * Page class
 */
class MedicalRecordsAdd extends MedicalRecords
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "MedicalRecordsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "medicalrecordsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "medicalrecordsview") {
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // doctor_id
        $this->doctor_id->setDbValueDef($newRow, $this->doctor_id->CurrentValue, false);

        // visit_date
        $this->visit_date->setDbValueDef($newRow, UnFormatDateTime($this->visit_date->CurrentValue, $this->visit_date->formatPattern()), false);

        // diagnosis
        $this->diagnosis->setDbValueDef($newRow, $this->diagnosis->CurrentValue, false);

        // treatment
        $this->treatment->setDbValueDef($newRow, $this->treatment->CurrentValue, false);

        // prescription
        $this->prescription->setDbValueDef($newRow, $this->prescription->CurrentValue, false);
        return $newRow;
    }
