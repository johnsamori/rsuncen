 ...
 * Page class
 */
class PharmacyDelete extends Pharmacy
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PharmacyDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "pharmacydelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("pharmacylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("pharmacylist"); // Return to list
                return;
            }
        }
