...
class PharmacyView extends Pharmacy
{
    ...
    // Page object name
    public string $PageObjName = "PharmacyView";
    ...
    // CSS class/style
    public string $CurrentPageName = "pharmacyview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "pharmacylist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("pharmacylist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pharmacylist"; // No matching record, return to list
                    } else {
