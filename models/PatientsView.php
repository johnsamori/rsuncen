...
class PatientsView extends Patients
{
    ...
    // Page object name
    public string $PageObjName = "PatientsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "patientsview";
