 ...
 */
class Transactions extends DbTable
{
    ...
    public DbField $pharmacy_id;
    public DbField $quantity;
    public DbField $total_price;
    public DbField $transaction_date;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "transactions"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // pharmacy_id
        $this->pharmacy_id = new DbField(
            $this, // Table
            'x_pharmacy_id', // Variable name
            'pharmacy_id', // Name
            '`pharmacy_id`', // Expression
            '`pharmacy_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`pharmacy_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->pharmacy_id->InputTextType = "text";
        $this->pharmacy_id->Raw = true;
        $this->pharmacy_id->Nullable = false; // NOT NULL field
        $this->pharmacy_id->Required = true; // Required field
        $this->pharmacy_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->pharmacy_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['pharmacy_id'] = &$this->pharmacy_id;
        ...
        $this->quantity->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->quantity->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['quantity'] = &$this->quantity;

        // total_price
        $this->total_price = new DbField(
            $this, // Table
            'x_total_price', // Variable name
            'total_price', // Name
            '`total_price`', // Expression
            '`total_price`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`total_price`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_price->InputTextType = "text";
        $this->total_price->Raw = true;
        $this->total_price->Nullable = false; // NOT NULL field
        $this->total_price->Required = true; // Required field
        $this->total_price->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
        $this->total_price->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['total_price'] = &$this->total_price;

        // transaction_date
        $this->transaction_date = new DbField(
            $this, // Table
            'x_transaction_date', // Variable name
            'transaction_date', // Name
            '`transaction_date`', // Expression
            CastDateFieldForLike("`transaction_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
            '`transaction_date`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->transaction_date->InputTextType = "text";
        $this->transaction_date->Raw = true;
        $this->transaction_date->Nullable = false; // NOT NULL field
        $this->transaction_date->Required = true; // Required field
        $this->transaction_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->transaction_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "transactions";
    }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->pharmacy_id->DbValue = $row['pharmacy_id'];
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("transactionslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "transactionsview" => $this->language->phrase("View"),
            "transactionsedit" => $this->language->phrase("Edit"),
            "transactionsadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TransactionsView",
            Config("API_ADD_ACTION") => "TransactionsAdd",
            Config("API_EDIT_ACTION") => "TransactionsEdit",
            Config("API_DELETE_ACTION") => "TransactionsDelete",
            Config("API_LIST_ACTION") => "TransactionsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("transactionsview", $parm);
        } else {
            $url = $this->keyUrl("transactionsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("transactionsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("transactionslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("transactionsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("transactionslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("transactionsdelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->transaction_date->EditValue = FormatDateTime($this->transaction_date->CurrentValue, $this->transaction_date->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->pharmacy_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->pharmacy_id);
