...
class Patients extends DbTable
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "patients"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->dob->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("patientslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "patientsview" => $this->language->phrase("View"),
            "patientsedit" => $this->language->phrase("Edit"),
            "patientsadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
