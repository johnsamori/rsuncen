...
class RoomsView extends Rooms
{
    ...
    // Page object name
    public string $PageObjName = "RoomsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "roomsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "roomslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "roomslist"; // No matching record, return to list
                    } else {
