 ...
 * Page class
 */
class MedicalRecordsView extends MedicalRecords
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MedicalRecordsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "medicalrecordsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicalrecordslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "medicalrecordslist"; // No matching record, return to list
                    } else {
