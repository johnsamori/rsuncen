 ...
 * Page class
 */
class RoomsDelete extends Rooms
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "RoomsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "roomsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("roomslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("roomslist"); // Return to list
                return;
            }
        }
