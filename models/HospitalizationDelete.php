 ...
 * Page class
 */
class HospitalizationDelete extends Hospitalization
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "HospitalizationDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "hospitalizationdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("hospitalizationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("hospitalizationlist"); // Return to list
                return;
            }
        }
