 ...
 * Page class
 */
class TransactionsDelete extends Transactions
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TransactionsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "transactionsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("transactionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("transactionslist"); // Return to list
                return;
            }
        }
