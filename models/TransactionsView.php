...
class TransactionsView extends Transactions
{
    ...
    // Page object name
    public string $PageObjName = "TransactionsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "transactionsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "transactionslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "transactionslist"; // No matching record, return to list
                    } else {
