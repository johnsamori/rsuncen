...
class AppointmentsEdit extends Appointments
{
    ...
    // CSS class/style
    public string $CurrentPageName = "appointmentsedit";
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'appointment_date' before field var 'x_appointment_date'
        $val = $this->hasFormValue("appointment_date") ? $this->getFormValue("appointment_date") : $this->getFormValue("x_appointment_date");
        if (!$this->appointment_date->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->appointment_date->Visible = false; // Disable update for API request
            } else {
                $this->appointment_date->setFormValue($val, true, $validate);
            }
            $this->appointment_date->CurrentValue = UnformatDateTime($this->appointment_date->CurrentValue, $this->appointment_date->formatPattern());
        }
    ...
    public function restoreFormValues(): void
    {
        ...
        $this->appointment_date->CurrentValue = $this->appointment_date->FormValue;
        $this->appointment_date->CurrentValue = UnformatDateTime($this->appointment_date->CurrentValue, $this->appointment_date->formatPattern());
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->appointment_date->EditValue = HtmlEncode(FormatDateTime($this->appointment_date->CurrentValue, $this->appointment_date->formatPattern()));
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->appointment_date->Visible && $this->appointment_date->Required) {
                if (!$this->appointment_date->IsDetailKey && IsEmpty($this->appointment_date->FormValue)) {
                    $this->appointment_date->addErrorMessage(str_replace("%s", $this->appointment_date->caption(), $this->appointment_date->RequiredErrorMessage));
                }
            }
            if (!CheckDate($this->appointment_date->FormValue, $this->appointment_date->formatPattern())) {
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // appointment_date
        $this->appointment_date->setDbValueDef($newRow, UnFormatDateTime($this->appointment_date->CurrentValue, $this->appointment_date->formatPattern()), $this->appointment_date->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['appointment_date'])) { // appointment_date
            $this->appointment_date->CurrentValue = $row['appointment_date'];
        }
