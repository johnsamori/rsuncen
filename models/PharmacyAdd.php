 ...
 * Page class
 */
class PharmacyAdd extends Pharmacy
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PharmacyAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "pharmacyadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pharmacyview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "pharmacylist") {
                            ...
                            $returnUrl = "pharmacylist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'stock' before field var 'x_stock'
        $val = $this->hasFormValue("stock") ? $this->getFormValue("stock") : $this->getFormValue("x_stock");
        ...
        $val = $this->hasFormValue("price") ? $this->getFormValue("price") : $this->getFormValue("x_price");
    ...
    protected function getAddRow(): array
    {
        ...
        // stock
        $this->stock->setDbValueDef($newRow, $this->stock->CurrentValue, strval($this->stock->CurrentValue) == "");

        // price
        $this->price->setDbValueDef($newRow, $this->price->CurrentValue, false);
        return $newRow;
    }
