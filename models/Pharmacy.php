...
/**
 * Table class for pharmacy
 */
class Pharmacy extends DbTable
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "pharmacy"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->stock->Raw = true;
        $this->stock->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        ...
        $this->price->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pharmacy";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("pharmacylist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "pharmacyview" => $this->language->phrase("View"),
            "pharmacyedit" => $this->language->phrase("Edit"),
            "pharmacyadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PharmacyView",
            Config("API_ADD_ACTION") => "PharmacyAdd",
            Config("API_EDIT_ACTION") => "PharmacyEdit",
            Config("API_DELETE_ACTION") => "PharmacyDelete",
            Config("API_LIST_ACTION") => "PharmacyList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pharmacyview", $parm);
        } else {
            $url = $this->keyUrl("pharmacyview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pharmacyedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pharmacylist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pharmacyadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pharmacylist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("pharmacydelete", $parm);
        }
    }
