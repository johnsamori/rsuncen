...
class RoomsAdd extends Rooms
{
    ...
    // Page object name
    public string $PageObjName = "RoomsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "roomsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "roomsview") {
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->room_number->CurrentValue != "") { // Check field with unique index
            $filter = "(`room_number` = '" . AdjustSql($this->room_number->CurrentValue) . "')";
    ...
    protected function getAddRow(): array
    {
        ...
        // room_number
        $this->room_number->setDbValueDef($newRow, $this->room_number->CurrentValue, false);

        // room_type
        $this->room_type->setDbValueDef($newRow, $this->room_type->CurrentValue, false);

        // price_per_day
        $this->price_per_day->setDbValueDef($newRow, $this->price_per_day->CurrentValue, false);
